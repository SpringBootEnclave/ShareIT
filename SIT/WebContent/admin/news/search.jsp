                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            %>
                            <p>Kết quả tìm kiếm cho "<span style="color:red"><%=text %></span>"</p>
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="<%=request.getContextPath() %>/admin/news/edit?id=<%=objNews.getId() %>&page=1" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                            <a href="<%=request.getContextPath() %>/admin/news/delete?id=<%=objNews.getId() %>&page=1" title="" onclick="return confirm('Bạn có chắc chắn muốn xóa')" class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</a>
                                        </td>
                                    </tr>
								<%}}%>
                                </tbody>

								...
								<%
                                		...
                                		if(newsList.size()>0){
                                			for(News objNews: newsList){
                                				String urlSlug = request.getContextPath()+ "/public/detail/index/" + StringUtil.makeSlug(objNews.getName())+"-"+ objNews.getId()+".html";
								...
								<div class="single-latest-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											...
											<a href="<%=urlSlug%>"><img class="img-fluid" src="<%=request.getContextPath() %>/files/<%=objNews.getPicture() %>" alt=""></a>
										</div>
										<ul class="tags">
											<li><a href="<%=request.getContextPath()%>/public/cat/index?cid=<%=objNews.getObjCat().getCatId()%>"><%=objNews.getObjCat().getCatName() %></a></li>
										</ul>
									</div>
									<div class="col-lg-7 post-right">
										<a href="<%=request.getContextPath()%>/public/detail/index?nid=<%=objNews.getId()%>">
										...
										<a href="<%=request.getContextPath()%>/public/detail/index?nid=<%=objNews.getId()%>">Xem chi tiết</a>
									</div>
								</div>
								<%}} %>
